...
export default function HotelBookingsHeader() {
  ...
  const {openHotels,setOpenHotels} = useContext(Agent)
      ...
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
        ...
        <div>
          ...
          <div className="flex flex-wrap items-center gap-2 mb-3 text-sm text-gray-400">
            <a href="/Agent" className="transition-all duration-300 hover:text-purple-400 hover:translate-x-0.5">
              الرئيسية
            </a>
            <FaChevronLeft className="text-xs text-gray-500" />
            <a href="/Agent/HotelPage" className="transition-all duration-300 hover:text-purple-400 hover:translate-x-0.5">
              الحجوزات
            </a>
            <FaChevronLeft className="text-xs text-gray-500" />
