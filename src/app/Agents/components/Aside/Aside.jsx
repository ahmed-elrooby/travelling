...
const Aside = () => {
  ...
  // قائمة الروابط - يمكنك تعديلها بسهولة
  const navItems = [
    {
      section: "الرئيسية",
      items: [
        ...
        <div className="p-4 border-b md:p-6 border-purple-500/20 bg-gradient-to-r from-gray-900/50 to-gray-800/50">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-400">B2B Agent Portal</p>
            </div>
          </div>
        </div>
                  ...
                  return (
                    <Link
                      ...
                      className={`
                        ...
                        ${
                          isActive
                            ? "bg-gradient-to-r from-purple-500/20 to-pink-500/20 text-white shadow-lg shadow-purple-500/10 border border-purple-500/30"
