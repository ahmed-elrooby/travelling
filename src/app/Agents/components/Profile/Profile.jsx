...
import { FaEnvelope, FaIdCard, FaUserTag, FaCheckCircle, FaShieldAlt, FaCalendarAlt } from 'react-icons/fa'
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 to-gray-800">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-400">جاري تحميل الملف الشخصي...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen ">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-gray-400">معلومات حساب مدير النظام</p>
        </div>
          ...
          <div className="relative px-6">
            <div className="absolute -top-12 right-6">
              <div className="relative">
                <img
                  src={`https://ui-avatars.com/api/?background=8b5cf6&color=fff&name=${encodeURIComponent(profile?.name || 'Admin')}&size=100&rounded=true&bold=true&length=2`}
                  alt={profile?.name}
                  className="w-24 h-24 shadow-xl rounded-2xl "
                />
                {/* Online status indicator */}
                {profile?.status === 'active' && (
                  <div className="absolute bottom-1 right-1 w-3.5 h-3.5 bg-green-500 rounded-full ring-2 "></div>
                )}
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 transition-all duration-300 border group rounded-xl bg-gray-800/30 border-purple-500/10 hover:border-purple-500/30 hover:bg-gray-800/50">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 text-right">
                    <p className="text-xs text-gray-400 mb-0.5">معرف المستخدم</p>
              ...
              <div className="p-4 transition-all duration-300 border group rounded-xl bg-gray-800/30 border-purple-500/10 hover:border-purple-500/30 hover:bg-gray-800/50">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 text-right">
                    <p className="text-xs text-gray-400 mb-0.5">الصلاحية</p>
                    <p className="font-medium text-white">{getRoleInArabic(profile?.role)}</p>
                  </div>
                </div>
              </div>
            </div>
