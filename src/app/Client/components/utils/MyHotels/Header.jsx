...
const Header = () => {
  ...
  const {setOpenHotels,openHotels}=useContext(Clients)
            ...
            <div className="flex flex-wrap items-center gap-2 mb-3 text-sm">
              ...
              {pathname !== '/Client' && (
                <>
                  ...
                  >
                    {getPageIcon()}
                    <span className={pathname?.includes('HotelsPage') ? 'text-white font-medium' : 'text-gray-400'}>
                      {pageTitle}
                    </span>
                  </Link>
                </>
