...
import { FaChevronLeft, FaPlusCircle, FaCar, FaBell, FaChartLine, FaCalendarAlt } from "react-icons/fa";
      ...
      <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-center">
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-2xl bg-gradient-to-r from-purple-500/20 to-pink-500/20 shadow-lg">
              <FaCar className="text-2xl text-purple-400" />
            </div>
            <div>
              <h2 className="text-3xl font-bold tracking-tight md:text-4xl bg-gradient-to-r from-purple-400 via-pink-400 to-purple-400 bg-clip-text text-transparent animate-gradient">
                السيارات والتأجير
              </h2>
              <p className="mt-1 text-sm text-gray-400 md:text-base">
                إدارة ومتابعة جميع حجوزات تأجير السيارات حول العالم
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          {/* Quick Stats Badge */}
          {/* <div className="hidden px-4 py-2 rounded-xl bg-white/5 border border-purple-500/20 lg:flex items-center gap-4">
            ...
            <div className="text-center">
              <p className="text-xs text-gray-400">السيارات المتاحة</p>
              <p className="text-xl font-bold text-green-400">142</p>
            </div>
            <div className="w-px h-8 bg-purple-500/20"></div>
            <div className="text-center">
              <p className="text-xs text-gray-400">إجمالي الإيرادات</p>
              <p className="text-xl font-bold text-blue-400">$28.3k</p>
            </div>
          </div> */}

          {/* Compact Stats for Mobile */}
          {/* <div className="flex px-3 py-2 rounded-xl bg-white/5 border border-purple-500/20 lg:hidden items-center gap-2">
            <FaCalendarAlt className="text-purple-400 text-sm" />
            <span className="text-white text-sm font-semibold">67 حجز نشط</span>
          </div> */}
          ...
          >
            ...
            <span className="relative z-10">حجز سيارة جديد</span>
          </button>
        </div>
      </div>
